...
async function main() {
  ...
  const firstNames = [
    // Чоловічі
    'Андрій', 'Богдан', 'Василь', 'Григорій', 'Дмитро', 'Олександр', 'Максим', 'Роман', 'Сергій', 'Віктор', 
    'Олексій', 'Микола', 'Тарас', 'Юрій', 'Артем', 'Іван', 'Степан', 'Петро', 'Михайло', 'Павло',
    'Олег', 'Денис', 'Євген', 'Владислав', 'Валентин', 'Кирило', 'Назар', 'Руслан', 'Ігор', 'Анатолій',
    'Леонід', 'Мирослав', 'Святослав', 'Ярослав', 'Матвій', 'Тимофій', 'Данило', 'Марко', 'Лука', 'Захар',
    // Жіночі
    'Анна', 'Марія', 'Олена', 'Вікторія', 'Дарія', 'Катерина', 'Ірина', 'Наталія', 'Оксана', 'Тетяна', 
    'Софія', 'Аліна', 'Юлія', 'Анастасія', 'Надія', 'Світлана', 'Людмила', 'Любов', 'Галина', 'Ніна',
    'Ольга', 'Валентина', 'Євгенія', 'Христина', 'Марина', 'Олександра', 'Вероніка', 'Яна', 'Зоряна', 'Олеся',
    'Мирослава', 'Богдана', 'Ангеліна', 'Діана', 'Поліна', 'Єлизавета', 'Соломія', 'Злата', 'Аліса', 'Мілана'
  ];
  const lastNames = [
    'Коваленко', 'Кравченко', 'Ткаченко', 'Мельник', 'Шевченко', 'Бондаренко', 'Ковальчук', 'Бойко', 'Олійник', 'Мороз', 
    'Савченко', 'Лисенко', 'Руденко', 'Марченко', 'Гриценко', 'Сидоренко', 'Павленко', 'Коваль', 'Гончаренко', 'Поліщук',
    'Василенко', 'Харченко', 'Петренко', 'Приходько', 'Кузьменко', 'Онищенко', 'Клименко', 'Даниленко', 'Панченко', 'Кравчук',
    'Дяченко', 'Федоренко', 'Пономаренко', 'Левченко', 'Степаненко', 'Козак', 'Романенко', 'Кириленко', 'Мельничук', 'Іваненко',
    'Яковенко', 'Терещенко', 'Мазур', 'Коломієць', 'Ткачук', 'Шевчук', 'Бондар', 'Котенко', 'Опанасенко', 'Дорошенко',
    'Назаренко', 'Пилипенко', 'Яценко', 'Лук\'яненко', 'Собчук', 'Дмитренко', 'Антоненко', 'Гончар', 'Кравченюк', 'Данилюк',
    'Медвідь', 'Ворона', 'Сорока', 'Орел', 'Береза', 'Дуб', 'Лобода', 'Мовчан', 'Палій', 'Пасічник',
    'Гаврилюк', 'Демчук', 'Савчук', 'Якубчак', 'Білоус', 'Чорний', 'Білий', 'Рудий', 'Кушнір', 'Кравець'
  ];
