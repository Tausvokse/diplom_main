...
Система управління гуртожитками з кабінетами студента, адмін‑панеллю, розподілом місць, скаргами/ремонтами, платежами та повідомленнями. mydormitory.tech логін та пароль для входу - admin@npp.kai.edu.ua : password123
